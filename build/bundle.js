...
var btoa = window.btoa || __webpack_require__(96);
...
var Hero = exports.Hero = function Hero(props) {
  ...
  return _react2.default.createElement(
    'div',
    { className: 'walker col-lg-2 col-md-3 col-sm-3 col-xs-6' },
...
var App = _react2.default.createClass({
	...
	componentDidMount: function componentDidMount() {
		...
		console.log('really fun');
		_axios2.default.get('http://swapi.co/api/people').then(function (stars) {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				this.state.heroes.map(function (hero) {
					return _react2.default.createElement(_Hero.Hero, { key: hero.name, name: hero.name, dob: 'birthday:' + hero.birth_year, url: 'sex:' + hero.gender });
				})
			)
		);
	}
});
_reactDom2.default.render(_react2.default.createElement(App, null), document.getElementById('fun'));
